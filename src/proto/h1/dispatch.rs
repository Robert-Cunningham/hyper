...
mod tests {
    ...
    fn client_read_bytes_before_writing_request() {
        ...
        tokio_test::task::spawn(()).enter(|cx, _| {
            ...
            let conn = Conn::<_, bytes::Bytes, ClientTransaction>::new(io, Tim::None); // TODO
    ...
    async fn client_flushing_is_not_ready_for_next_request() {
        ...
        let (mut tx, rx) = crate::client::dispatch::channel();
        let mut conn = Conn::<_, bytes::Bytes, ClientTransaction>::new(io, Tim::None);
    ...
    async fn body_empty_chunks_ignored() {
        ...
        let (mut tx, rx) = crate::client::dispatch::channel();
        let conn = Conn::<_, bytes::Bytes, ClientTransaction>::new(io, Tim::None);
